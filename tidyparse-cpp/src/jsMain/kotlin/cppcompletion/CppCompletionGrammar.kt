 ...
 * conditioner has already established a dense child-before-parent index, so the bounded-CFG
 * constructor can use it directly rather than grouping and validating the same thousands of
 * productions at each cursor.
 */
