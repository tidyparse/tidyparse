 ...
 *
 * Imports remain lazy because tidyparse-cpp.js is also evaluated in the clangd
    ...
    val url = js(
      """(href) => {
        ...
        const cppBootstrapControlsPage =
          controllerUrl &&
          controllerUrl.pathname.endsWith("/tidyparse-cpp.js") &&
          controllerUrl.searchParams.has("cpp-coi");
        const result = cppBootstrapControlsPage
          ? new URL(href)
          : new URL("tidyparse-cpp.js", href);
        result.search = "";
        result.hash = "";
