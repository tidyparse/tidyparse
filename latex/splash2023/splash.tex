...
\acmConference[POPL'24]{SIGPLAN Symposium on Principles of Programming Languages}{January 17-19, 2024}{London, United Kingdom}
%\acmYear{2018}
...
\begin{wrapfigure}{r}{0.45\textwidth}
  \resizebox{.45\textwidth}{!}{\input{nfa_cfg.tex}}
...
\begin{wrapfigure}{r}{0.33\textwidth}
  ...
  \caption{General case of subexpression rediction.}
\end{wrapfigure}
...
\subsection{Tree Denormalization}
...
\subsection{Parser incrementalization}\label{sec:incrementalization}
...
\begin{figure}[H]
  \resizebox{0.99\textwidth}{!}{\input{binary_trees.tex}}
\end{figure}
...
\begin{wrapfigure}{R}{0.4\textwidth}
  \begin{center}
  \resizebox{.3\textwidth}{!}{\input{error_recovery.tex}}
  \end{center}
  \caption{By recursing over upper diagonals of decreasing elevation and discarding all subtrees that fall under the shadow of another's canopy, we can recover the partial subtrees. The example depicted above contains three such branches, rooted at nonterminals $C, B, A$.}\label{fig:peaks}
\end{wrapfigure}
...
\caption{Adaptive sampling repairs. The red line indicates Seq2Parse precision@1 on the same dataset.}
\end{figure}
