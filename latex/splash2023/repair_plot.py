...
def plot_data(data, filename):
    ...
    second_mapping = {f"{i}": i for i in range(1500, 0, -100)}
...
all_edits_ms = """
P@1=   1500s: 0.336, 1400s: 0.336, 1300s: 0.328, 1200s: 0.328, 1100s: 0.32, 1000s: 0.312, 900s: 0.304, 800s: 0.296, 700s: 0.296, 600s: 0.296, 500s: 0.288, 400s: 0.272, 300s: 0.256, 200s: 0.224, 100s: 0.184
P@5=   1500s: 0.488, 1400s: 0.488, 1300s: 0.48, 1200s: 0.48, 1100s: 0.464, 1000s: 0.456, 900s: 0.448, 800s: 0.44, 700s: 0.416, 600s: 0.408, 500s: 0.4, 400s: 0.384, 300s: 0.376, 200s: 0.312, 100s: 0.28
P@10=  1500s: 0.536, 1400s: 0.536, 1300s: 0.528, 1200s: 0.528, 1100s: 0.512, 1000s: 0.504, 900s: 0.496, 800s: 0.48, 700s: 0.456, 600s: 0.448, 500s: 0.44, 400s: 0.416, 300s: 0.4, 200s: 0.336, 100s: 0.296
P@All= 1500s: 0.6, 1400s: 0.6, 1300s: 0.592, 1200s: 0.584, 1100s: 0.56, 1000s: 0.552, 900s: 0.544, 800s: 0.52, 700s: 0.496, 600s: 0.48, 500s: 0.472, 400s: 0.44, 300s: 0.424, 200s: 0.352, 100s: 0.304
"""

# conda deactivate && conda activate cstk
if __name__ == '__main__':
    pattern = r"(P@\w+)=((?:\s+\d+s:\s+\d+\.\d+,?)+)"
    matches = re.findall(pattern, all_edits_ms)
